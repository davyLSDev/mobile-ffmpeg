# mobile-ffmpeg
The purpose of this fork is to be able to build the Android archive needed to build the Android application known as [StoryProducer](https://github.com/sillsdev/StoryProducer).

## Authors
* current maintainer: [Davy Tenn](https://github.com/davyLSDev) 
* Original author: [Taner Sener](https://github.com/tanersener)

## Background
MobileFFmpeg is a fork from [mobile-ffmpeg](https://github.com/tanersener/mobile-ffmpeg) and is no longer maintained by the author - see below[StoryProducer](https://github.com/sillsdev/StoryProducer)
...
The version that [StoryProducer](https://github.com/sillsdev/StoryProducer) has used mobile-ffmpeg-full-4.2.LTS.aar.

## Caveat Emptor

* **The main goal:** The branch *docker-build-setup* was intended to set up a docker build agent to build this library. It does build an aar, but it does not build the proper aar file for StoryProducerApp. 
* The branch *build-v4.2.LTS* currently doesn't build anything.
* The branches *develop* and *master* will be renamed once the main goal for this library works to re-establish a *develop* and *master* branch that makes sense for this repo. Then, once the work is done on the *build_v4.2.LTS* branch, then it will become the new starting point for new branches named *deveolp* and *master*
* There is **no intention** of maintaining or even developing the full capability of this library.

## Currently developing on build-v4.2.LTS branch
To use this project:

0. Ensure you have a modern docker installed on your workstation
1. checkout 'build-v4.2.LTS' branch
2. run ./build_android.sh
3. the artefact you need, mobile-ffmpeg-full-4.2.LTS.aar, should be in ../prebuilt/android-aar/movile-ffmpeg/

This file should be about 57.4Mb with an architecture like:
--arm64-v8a/[empty]
--armeai-v7a/[empty]
--jni/{arm64-v8a/|armeabi-v7a/|x86/|x86_65} - these have a bunch of *.so files
--mipmap-hdpi-v4/[empty]
--mipmap-mdpi-v4/[empty]
--mipmap-xhdpi-v4/[empty]
--mipmap-xxhdpi-v4/[empty]
--mipmap-xxxhdpi-v4/[empty]
--res/{mipmap-hdpi-v4/|mipmap-mdpi-v4/|mipmap-xhdpi-v4/|mipmap-xxhdpi-v4/|mipmap-xxxhdpi-v4/|values} - these have a few *.png files, the values folder has values.xml
--values/[empty]
--x86/[empty]
--x86_64/[empty]
AndroidManifest.xml
...
<img src="https://github.com/tanersener/mobile-ffmpeg/blob/master/docs/assets/mobile-ffmpeg-logo-v7.png" width="320"># MobileFFmpeg is a fork from [mobile-ffmpeg](https://github.com/tanersener/mobile-ffmpeg) and is no longer maintained by the author - see below
Previously the build artifact from jcentre was used to build Story Producer App is no longer accessible since it was shut down.
